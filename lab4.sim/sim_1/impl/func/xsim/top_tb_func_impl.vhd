...
-- Date        : Mon Mar  9 13:36:29 2020
-- Host        : JacobOffersen running 64-bit Ubuntu 19.10
-- Command     : write_vhdl -mode funcsim -nolib -force -file
--               /home/jacoboffersen/advanced_programmable_electronics/lab4_2/lab4.sim/sim_1/impl/func/xsim/top_tb_func_impl.vhd
-- Design      : top
...
architecture STRUCTURE of binary_counter is
  ...
  signal \NLW_q_reg[0]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \NLW_q_reg[4]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
begin
  CLK <= \^clk_1\;
...
\q_reg[0]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2 downto 0) => \NLW_q_reg[0]_i_1_CO_UNCONNECTED\(2 downto 0),
      CYINIT => '0',
...
\q_reg[4]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => \q_reg[0]_i_1_n_0\,
      CO(3 downto 0) => \NLW_q_reg[4]_i_1_CO_UNCONNECTED\(3 downto 0),
      CYINIT => '0',
...
entity uart_tx is
  port (
    \substate_reg[0]_0\ : out STD_LOGIC;
...
architecture STRUCTURE of uart_tx is
  ...
  signal \^substate_reg[0]_0\ : STD_LOGIC;
  signal \substate_reg_n_0_[0]\ : STD_LOGIC;
  signal \substate_reg_n_0_[1]\ : STD_LOGIC;
  signal tx_data : STD_LOGIC_VECTOR ( 5 downto 1 );
  ...
  attribute SOFT_HLUTNM of \tx_data_snapshot[3]_i_1\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \tx_data_snapshot[7]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of tx_out_hw_OBUF_inst_i_2 : label is "soft_lutpair0";
begin
  \substate_reg[0]_0\ <= \^substate_reg[0]_0\;
...
tx_out_hw_OBUF_inst_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FB0BFA0AEB28E828"
    )
        port map (
      I0 => tx_out_hw_OBUF_inst_i_2_n_0,
      I1 => \state_reg__0\(1),
      I2 => \state_reg__0\(2),
      I3 => tx_out_hw_OBUF_inst_i_3_n_0,
      I4 => \state_reg__0\(3),
      I5 => \state_reg__0\(0),
      O => tx_out_hw_OBUF
    );
tx_out_hw_OBUF_inst_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"E323E020"
    )
        port map (
...
tx_out_hw_OBUF_inst_i_3: unisim.vcomponents.LUT6
    generic map(
...
uart_tx0: entity work.uart_tx
     port map (
      ...
      \substate_reg[0]_0\ => \substate_reg[0]\,
...
entity top is
  ...
  attribute ECO_CHECKSUM of top : entity is "1733ffa2";
end top;
...
architecture STRUCTURE of top is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \tx_index[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \tx_index[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \tx_index[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \tx_index[3]_i_1\ : label is "soft_lutpair6";
begin
...
uart_module0: entity work.uart_module
     port map (
      ...
      running_reg => tx_done,
      \substate_reg[0]\ => uart_module0_n_0,
      tx_out_hw_OBUF => tx_out_hw_OBUF
    );
end STRUCTURE;
